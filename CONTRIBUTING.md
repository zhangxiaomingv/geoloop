...
- **Bilingual docs**: README is the AI-facing fact card (English-first, Chinese inline). Product docs (`IDENTITY-ENGINE.md`, `VISION.md`) stay Chinese. Keep the author line: 张可能 / GEOloop 创始人.
